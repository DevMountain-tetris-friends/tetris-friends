...
//     <p>
//       Searching for exams in a PDF is painful. We feel it. While there are
//       existing tools that allows you to type to search, we wanted to simplify it
//       even more -- Can we do it without search bars? Without typing five course
//       numbers? After hard work, we made this, for you❤️.
//     </p>
//   </div>
// );
...
//     <h2>Is It Safe?</h2>
//     <p>
//       This tool does not store your credentials. It transmit your credentials in
//       a secure way to the McGill LDAP API, to query your courses. The API only
//       allows us to know the courses you're enrolled, not your grade or any kind
//       of personal privacy. You can review the source code{" "}
